...
- 資產命名：不適用
- alt 與連結文字：不適用
- 目前最新正確來源：`atomic/090-title標籤/`
- 後續流程：atomic 內容審查已完成，下一步生成 `notes/090-title標籤/`
...
- 生成 `notes/090-title標籤/`。
- 完成 `notes/090-title標籤/` 內容檢查後，依標準輸出規則生成或同步 `appendix/`、`demos/`、`practice/`、`review/`。
