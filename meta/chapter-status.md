...
| 第02章_HTML簡介 | 未設定 | 待確認 | 待確認 | 待確認 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 0% | 進行中 | 檢查 origin 資產路徑與 alt，再啟動 origin -> atomic。 | origin 原始資料已初始匯入，尚未完成資料整理與下游產出；詳細紀錄見 [章節 log](chapter-logs/第02章_HTML簡介.md)。 |
