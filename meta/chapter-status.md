...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 測試 | 未設定 | 待確認 | 已完成 | 已完成 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 15% | 進行中 | 執行 origin → atomic 切分提案。 | 已確認 10 份 origin Markdown 中的 6 個本地圖片引用皆使用 `./assets/images/...`，且檔名 hash6 與 SHA-256 前 6 碼一致；已完成 6 個本地圖片 alt 整理，未發現本地附件連結。 |
