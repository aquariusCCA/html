...
| 第02章_HTML簡介 | 未設定 | 待確認 | 已完成 | 待確認 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 未開始 | 8% | 進行中 | 檢查圖片 alt、連結文字與 origin 格式，再啟動 origin -> atomic。 | origin 原始資料已初始匯入；資產檔名與引用路徑已標準化；尚未產生下游；詳細紀錄見 [章節 log](chapter-logs/第02章_HTML簡介.md)。 |
