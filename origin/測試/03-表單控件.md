...
- type 的屬性值如下 :
    ...
    ![type的屬性值.png](./assets/images/form-controls-img-001-849948.png)
    
- 除了 type 屬性外，`<input>` 標籤還有其他很多屬性，其他常用屬性如下 :
    
    ![input標籤其他常用屬性.png](./assets/images/form-controls-img-002-417f2d.png)
...
- 新增的類型如下:
    ...
    ![新增的input類型.png](./assets/images/form-controls-img-003-b918e4.png)
