...
- type 的屬性值如下 :
    ...
    ![input type 屬性值與用途表](./assets/images/form-controls-img-001-849948.png)
    
- 除了 type 屬性外，`<input>` 標籤還有其他很多屬性，其他常用屬性如下 :
    
    ![input 標籤常用屬性與用途表](./assets/images/form-controls-img-002-417f2d.png)
...
- 新增的類型如下:
    ...
    ![HTML5 input 新增類型與用途表](./assets/images/form-controls-img-003-b918e4.png)
