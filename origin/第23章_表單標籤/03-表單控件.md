...
- type 的屬性值如下 :
    ...
    ![type的屬性值.png](./assets/images/type-attribute-values.png)
    
- 除了 type 屬性外，`<input>` 標籤還有其他很多屬性，其他常用屬性如下 :
    
    ![input標籤其他常用屬性.png](./assets/images/input-tag-common-attributes.png)
...
- 新增的類型如下:
    ...
    ![新增的input類型.png](./assets/images/new-input-types.png)
