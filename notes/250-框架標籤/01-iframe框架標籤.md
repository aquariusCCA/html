...
```html
<iframe src="https://www.bilibili.com/" title="B站首頁" width="900" height="300" style="border: 0;"></iframe>
```

這段程式碼會在頁面中建立一個寬 `900`、高 `300` 的框架，並在裡面載入 `https://www.bilibili.com/`。`title` 則用來描述這個 iframe 的內容，讓輔助工具使用者知道框架中載入的是什麼。
